...
def new_heuristic(
    ...
    king_weight=767,
    king_growth_decay=0.18566206457925264,
    back_row_weight=433,
    back_growth_decay=-0.3293593518395029,
    capture_weight=28,
    ...
    turn_advantage_weight=98,  # This parameter was not in your initial function definition
    verge_weight=100,
