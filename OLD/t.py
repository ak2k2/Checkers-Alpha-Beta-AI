# https://github.com/dimitrijekaranfilovic/checkers/tree/master
...
class Checkers:
    ...
    def get_player_input(self):
        ...
        while True:
            ...
            move_ind = input(
                f"pick a move from the list by choosing an index: {available_moves}\n"
            )
            coord1 = available_moves[int(move_ind)][0:2]
            coord2 = available_moves[int(move_ind)][2:4]
            # if coord1 == "":
            ...
            # new = coord2.split(",")
            print(coord1, coord2)
            # convert coord 1 and coord2 from lists like [1,2] to integers 12

            old = "".join(map(str, coord1))
            new = "".join(map(str, coord2))
            ...
            if len(old) != 2 or len(new) != 2:
                ...
                if (
                    not old_i.isdigit()
                    or not old_j.isdigit()
                    or not new_i.isdigit()
                    ...
                    if move not in available_moves:
                        ...
                        for m in range(8):
                            for n in range(8):
                                if (
                                    self.matrix[m][n][0] == "c"
                                    or self.matrix[m][n][0] == "C"
                                ):
                                    self.computer_pieces += 1
                                elif (
                                    self.matrix[m][n][0] == "b"
                                    or self.matrix[m][n][0] == "B"
                                ):
    ...
    def evaluate_states(self):
        ...
        for i in range(len(first_computer_moves)):
            ...
            value = Checkers.minimax(
                child.get_board(), 6, -math.inf, math.inf, False, self.mandatory_jumping
            )
            dict[value] = child
        if len(dict.keys()) == 0:
    ...
    def play(self):
        ...
        while True:
            ...
            if self.player_pieces == 0:
                ...
                self.print_matrix()
                print(
                    ansi_green + "Computer has no pieces left.\nYOU WIN!" + ansi_reset
                )
                exit()
